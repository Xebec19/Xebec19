				...
				<li><a href="mailto:rohant946@gmail.com" target="_self" rel="noreferrer" title="Email"><FontAwesomeIcon className="dim" icon={['fab','mailchimp']} size="3x" /></a></li>  {/*mail logo and link*/}
				</ul>
				</div>
