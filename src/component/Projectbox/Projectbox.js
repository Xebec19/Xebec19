...
import photo5 from './facedetect.png';  /*Import photo for face detection*/
...
{/*Card for Face Detection*/}
<div className="card aboutbox grow">
<img src={photo5} className="imageLeft" alt="face detection" />

<div className="contentRight">
<h3>Face Detection</h3>
<p>It is a Full-Stack application. I have used ReactJS for Frontend, NodeJS/ExpressJS for backend, PostgreSQL for database and Heroku for deployment</p><br/>
